  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-gray-900">Summer Internship Opportunity</h2>
        
        <div className="mb-4">
          <h3 className="text-xl font-medium mb-2 text-gray-900">About Us</h3>
        ...
        <div className="mb-4">
          <h3 className="text-xl font-medium mb-2 text-gray-900">Internship Description</h3>
          <p className="text-gray-700 mb-4">
        ...
        <div className="mb-4">
          <h3 className="text-xl font-medium mb-2 text-gray-900">Qualifications</h3>
          <ul className="list-disc pl-5 mb-4 text-gray-700">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2 text-gray-900">How to Apply</h3>
